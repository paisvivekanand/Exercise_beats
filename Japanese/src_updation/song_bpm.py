...
conf_handler.read(r'/home/ubuntu/Desktop/ISIF/backup/STEF/headphones/config/conf.ini')
...
def generate_bpm_and_time_pickles():
    ...
    for f in song_list:
        ...
        song_length.update({f: len1})
        print("******")
        print(f)
        for i in dtempo[:len1:3]:
            print(i)
    print(song_length)
